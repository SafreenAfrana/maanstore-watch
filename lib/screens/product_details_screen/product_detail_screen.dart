                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                const SizedBox(width: 10),
                                MyGoogleText(
                                  text: isRtl ? HardcodedTextArabic.totalReview : HardcodedTextEng.totalReview,
                                  fontSize: 16,
                            ...
                            MyGoogleText(
                              text: isRtl ? HardcodedTextArabic.deliveryAndSer : HardcodedTextEng.deliveryAndSer,
                              fontSize: 16,
                              fontColor: Colors.black,
                              fontWeight: FontWeight.normal,
                            ),
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      MyGoogleText(
                                        text: isRtl ? HardcodedTextArabic.freeDelivery : HardcodedTextEng.freeDelivery,
                                        fontSize: 16,
                                        fontColor: Colors.black,
                                        fontWeight: FontWeight.normal,
                                      ),
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      const SizedBox(width: 8),
                                      MyGoogleText(
                                        text: isRtl ? HardcodedTextArabic.payOnDelivery : HardcodedTextEng.payOnDelivery,
                                        fontSize: 16,
                                        fontColor: Colors.black,
                                        fontWeight: FontWeight.normal,
                                      ),
                              ...
                              return Column(
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: MyGoogleText(
                                      text: isRtl ? HardcodedTextArabic.relatedProducts : HardcodedTextEng.relatedProducts,
                                      fontSize: 16,
                                      fontColor: Colors.black,
                                      fontWeight: FontWeight.normal,
                                    ),
              ...
              child: Row(
                ...
                children: [
                  Consumer(builder: (_, ref, child) {
                    ...
                    return Expanded(
                      child: Button1(
                          buttonText: isRtl ? HardcodedTextArabic.buyNowButton : HardcodedTextEng.buyNowButton,
                          buttonColor: primaryColor,
                          onPressFunction: () {
