      ...
      return Directionality(
        ...
        child: Scaffold(
          appBar: AppBar(
            ...
            title: MyGoogleText(
              text: isRtl ? HardcodedTextArabic.profileScreenName : HardcodedTextEng.profileScreenName,
                      ...
                      children: [
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  MyGoogleText(
                                      text: '${snapShot.firstName} ${snapShot.lastName}', fontSize: 24, fontColor: Colors.black, fontWeight: FontWeight.normal),
                        ...
                        Container(
                          ...
                          child: ListTile(
                            ...
                            title: MyGoogleText(
                                text: isRtl ? HardcodedTextArabic.myProfile : HardcodedTextEng.myProfile,
                                fontSize: 16,
                                fontColor: Colors.black,
                                fontWeight: FontWeight.normal),
                            trailing: const Icon(
                        ...
                        Container(
                          ...
                          child: ListTile(
                            ...
                            title: MyGoogleText(
                                text: isRtl ? HardcodedTextArabic.language : HardcodedTextEng.language,
                                fontSize: 16,
                                fontColor: Colors.black,
                                fontWeight: FontWeight.normal),
                            trailing: const Icon(
                        ...
                        Container(
                          ...
                          child: ListTile(
                            ...
                            title: MyGoogleText(
                                text: isRtl ? HardcodedTextArabic.signOut : HardcodedTextEng.signOut,
                                fontSize: 16,
                                fontColor: Colors.black,
                                fontWeight: FontWeight.normal),
                            trailing: const Icon(
